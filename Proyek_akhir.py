...
curricular_units_1st_sem_grade = st.number_input('Rata-Rata nilai pada Semester 1', min_value=0.0, max_value=19.0, format="%.2f")
...
curricular_units_2nd_sem_grade = st.number_input('Rata-Rata nilai pada Semester 2', min_value=0.0, max_value=19.0, format="%.2f")

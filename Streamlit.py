...
# Nilai mean untuk kolom lainnya
mean_values = {
...
# Input nilai untuk keempat kolom
curricular_units_1st_sem_approved = st.number_input('Berapa banyak kursus yang diambil pada kurikulum Semester 1', min_value=0)
curricular_units_1st_sem_grade = st.number_input('Rata-Rata nilai Semester 1', min_value=0.0, format="%.2f")
curricular_units_2nd_sem_approved = st.number_input('Berapa banyak kursus yang diambil pada Semester 2', min_value=0)
curricular_units_2nd_sem_grade = st.number_input('Rata-Rata nilai Semester 2', min_value=0.0, format="%.2f")
...
if st.button('Prediksi'):
    ...
    st.write("Hasil Prediksi untuk Data Siswa Baru:", prediksi_baru[0])
